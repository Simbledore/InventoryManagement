...
import { ArticleView, ArticleSearchModel } from "./article.models";
...
export function ArticleSearch(props: Props) {
  ...
  const submit = async (values: ArticleSearchModel) => {
    try {
      ...
      props.setError(
        "Beim Suchen der Artikel ist ein Fehler aufgetreten, bitte kontaktieren Sie einen Administrator"
      );
    }
  };
